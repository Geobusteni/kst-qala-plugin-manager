...
class AdminPageTest extends TestCase {
	...
	/**
	 * Test: init() registers admin_enqueue_scripts hook for localization
	 *
	 * @return void
	 */
	public function test_init_registers_enqueue_scripts_hook(): void {
		Actions\expectAdded( 'admin_enqueue_scripts' )
			->once()
			->with( [ $this->admin_page, 'localize_script' ] );
	...
	public function test_enqueue_assets_only_on_settings_page(): void {
		...
		$this->admin_page->localize_script( 'index.php' );
	}

	/**
	 * Test: localize_script() localizes on settings page
	 *
	 * @return void
	 */
	public function test_enqueue_assets_enqueues_css_on_settings_page(): void {
		...
		$this->admin_page->localize_script( 'settings_page_qala-hide-notices' );
	}

	/**
	 * Test: localize_script() includes all required nonces
	 *
	 * @return void
	 */
